...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEGMENTFILTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEGMENTFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEGMENTFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEGMENTFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEGMENTFILTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEGMENTFILTER actions', async () => {
      const expectedActions = [
        {
