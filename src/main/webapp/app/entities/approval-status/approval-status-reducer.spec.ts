...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPROVALSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPROVALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPROVALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPROVALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPROVALSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPROVALSTATUS actions', async () => {
      const expectedActions = [
        {
