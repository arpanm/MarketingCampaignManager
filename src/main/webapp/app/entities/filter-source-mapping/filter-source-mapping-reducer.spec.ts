...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './filter-source-mapping.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILTERSOURCEMAPPING_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILTERSOURCEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILTERSOURCEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILTERSOURCEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILTERSOURCEMAPPING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILTERSOURCEMAPPING actions', async () => {
      const expectedActions = [
        {
