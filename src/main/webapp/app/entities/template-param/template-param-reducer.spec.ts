...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATEPARAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATEPARAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATEPARAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATEPARAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATEPARAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATEPARAM actions', async () => {
      const expectedActions = [
        {
