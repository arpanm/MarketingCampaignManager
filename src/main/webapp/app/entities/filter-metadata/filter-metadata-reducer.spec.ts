...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILTERMETADATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILTERMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILTERMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILTERMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILTERMETADATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILTERMETADATA actions', async () => {
      const expectedActions = [
        {
