...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './segment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEGMENT actions', async () => {
      const expectedActions = [
        {
