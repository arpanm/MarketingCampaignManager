...
export const TemplateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="marketingCampaignManagerApp.template.delete.question">
        <Translate contentKey="marketingCampaignManagerApp.template.delete.question" interpolate={{ id: templateEntity.id }}>
