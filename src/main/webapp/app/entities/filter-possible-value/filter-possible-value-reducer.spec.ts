...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './filter-possible-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILTERPOSSIBLEVALUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILTERPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILTERPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILTERPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILTERPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILTERPOSSIBLEVALUE actions', async () => {
      const expectedActions = [
        {
