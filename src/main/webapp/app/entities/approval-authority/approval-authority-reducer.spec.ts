...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './approval-authority.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPROVALAUTHORITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPROVALAUTHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPROVALAUTHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPROVALAUTHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPROVALAUTHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPROVALAUTHORITY actions', async () => {
      const expectedActions = [
        {
