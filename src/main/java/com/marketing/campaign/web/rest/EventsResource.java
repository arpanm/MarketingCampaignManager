...
/**
 * REST controller for managing {@link com.marketing.campaign.domain.Events}.
 */
@RestController
@RequestMapping("/api")
public class EventsResource {
     ...
     */
    @GetMapping("/events")
    public ResponseEntity<List<EventsDTO>> getAllEvents(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Events");
        Page<EventsDTO> page = eventsService.findAll(pageable);
